			...
			var saveAs = saveAs || (function (view) {
				...
				var
					...
					, FileSaver = function (blob, name, no_auto_bom) {
						...
						// First try a.download, then web filesystem, then object url
						var
							filesaver = this
							, type = blob.type
							...
							// on any filesys errors revert to saving with object url
							, fs_error = function () {
								if ((is_chrome_ios || (force && is_safari)) && view.FileReader) {
									// Safari doesn't allow downloading of blob url
								...
								// don't create more object url than needed
								if (!object_url) {
